 ...
 * @generated
 */
public class GhmdePackageImpl extends EPackageImpl implements GhmdePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see ghmde.GhmdePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private GhmdePackageImpl() {
		super(eNS_URI, GhmdeFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link GhmdePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static GhmdePackage init() {
		if (isInited) return (GhmdePackage)EPackage.Registry.INSTANCE.getEPackage(GhmdePackage.eNS_URI);

		// Obtain or create and register package
		GhmdePackageImpl theGhmdePackage = (GhmdePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof GhmdePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new GhmdePackageImpl());

		isInited = true;

		// Create package meta-data objects
		theGhmdePackage.createPackageContents();

		// Initialize created meta-data
		theGhmdePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theGhmdePackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(GhmdePackage.eNS_URI, theGhmdePackage);
		return theGhmdePackage;
	}
	 ...
	 * @generated
	 */
	public EReference getModel_Technologies() {
	 ...
	 * @generated
	 */
	public EReference getRepository_Files() {
	 ...
	 * @generated
	 */
	public EReference getUser_Repositories() {
	 ...
	 * @generated
	 */
	public EAttribute getTechnology_Title() {
	 ...
	 * @generated
	 */
	public EAttribute getTechnology_SearchResults() {
	 ...
	 * @generated
	 */
	public EReference getTechnology_Files() {
	 ...
	 * @generated
	 */
	public EReference getFile_Repository() {
	 ...
	 * @generated
	 */
	public EReference getFile_Commits() {
	 ...
	 * @generated
	 */
	public EReference getFile_Technologies() {
	 ...
	 * @generated
	 */
	public EReference getCommit_User() {
	 ...
	 * @generated
	 */
	public GhmdeFactory getGhmdeFactory() {
		return (GhmdeFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(modelEClass, MODEL__TECHNOLOGIES);
		...
		createEReference(repositoryEClass, REPOSITORY__FILES);
		createEReference(repositoryEClass, REPOSITORY__OWNER);

		userEClass = createEClass(USER);
		createEAttribute(userEClass, USER__ID);
		createEAttribute(userEClass, USER__NAME);
		createEReference(userEClass, USER__REPOSITORIES);

		technologyEClass = createEClass(TECHNOLOGY);
		createEAttribute(technologyEClass, TECHNOLOGY__NAME);
		createEAttribute(technologyEClass, TECHNOLOGY__TITLE);
		createEAttribute(technologyEClass, TECHNOLOGY__SEARCH_RESULTS);
		createEReference(technologyEClass, TECHNOLOGY__FILES);

		fileEClass = createEClass(FILE);
		createEAttribute(fileEClass, FILE__PATH);
		createEReference(fileEClass, FILE__REPOSITORY);
		createEReference(fileEClass, FILE__COMMITS);
		createEReference(fileEClass, FILE__TECHNOLOGIES);

		commitEClass = createEClass(COMMIT);
		createEAttribute(commitEClass, COMMIT__DATE);
		createEReference(commitEClass, COMMIT__USER);
	...
	public void initializePackageContents() {
		...
		initEReference(getModel_Technologies(), this.getTechnology(), null, "technologies", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRepository_Files(), this.getFile(), this.getFile_Repository(), "files", null, 0, -1, Repository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRepository_Owner(), this.getUser(), this.getUser_Repositories(), "owner", null, 0, 1, Repository.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUser_Repositories(), this.getRepository(), this.getRepository_Owner(), "repositories", null, 0, -1, User.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTechnology_Title(), ecorePackage.getEString(), "title", null, 0, 1, Technology.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTechnology_SearchResults(), ecorePackage.getEInt(), "searchResults", null, 0, 1, Technology.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTechnology_Files(), this.getFile(), this.getFile_Technologies(), "files", null, 0, -1, Technology.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFile_Repository(), this.getRepository(), this.getRepository_Files(), "repository", null, 0, 1, File.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFile_Commits(), this.getCommit(), null, "commits", null, 0, -1, File.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFile_Technologies(), this.getTechnology(), this.getTechnology_Files(), "technologies", null, 0, -1, File.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCommit_User(), this.getUser(), null, "user", null, 0, 1, Commit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCommit_Author(), this.getDeveloper(), null, "author", null, 0, 1, Commit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
